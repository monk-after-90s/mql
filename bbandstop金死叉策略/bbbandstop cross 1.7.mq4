   ...
   if(currency1=="USD" || currency2=="USD" || currency1=="CAD" || currency2=="CAD")
     {
      ...
      if(TimeYear(USDDSTbegin)!=TimeYear(TimeGMT()-5*3600) || TimeYear(USDDSTend)!=TimeYear(TimeGMT()-5*3600))
        {
         USDDSTbegin=D'1.3 2:00:00';
         static char count=0;
         do
           {
      ...
      if(TimeGMT()-5*3600>USDDSTbegin && TimeGMT()-5*3600<USDDSTend)
        {
         if(TimeHour(TimeGMT()-5*3600)>7 && TimeHour(TimeGMT()-5*3600)<15)
           {
            return 1;
           }
        }
        ...
        {
         if(TimeHour(TimeGMT()-5*3600)>8 && TimeHour(TimeGMT()-5*3600)<16)
           {
            return 1;
           }
        }
