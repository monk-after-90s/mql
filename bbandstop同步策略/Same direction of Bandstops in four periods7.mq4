...
extern float lots=0.1;                              //Initial lots
...
void correctlots()
  {
   ...
   const static float initial=lots;float losslots;
...
//|                                                                  |
//+------------------------------------------------------------------+
bool lastorderbenefit(float&losslots)//return 1 if the newest closed buy or sell order of the current symbol opened by the EA do not lose profit,otherwise 0
  {
...
//---
   ...
   if(trailstopvote() && 
      same8(trend,last_line,last_timeframe) && 
