...
extern double lots=0.1;       //Fixed order lots
input float marginofonelot=0;   //Margin every one lot distributed for on average
...
void correctlots()
  {
   if(marginofonelot==0)return;
   lots=NormalizeDouble(AccountInfoDouble(ACCOUNT_MARGIN_FREE)/marginofonelot,2);
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
