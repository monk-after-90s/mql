...
char bbvote()
  {
   char count=0;
   for(char i=(char)onetick;;i++)
     {
      double bb1=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length1,2,1.0,1,1,1000,false,0,i);/*UpTrend Stop*/
      double bb2=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length2,2,1.0,1,1,1000,false,0,i);/*UpTrend Stop*/
   ...
   for(char i=(char)onetick;;i++)
     {
      double bb1=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length1,2,1.0,1,1,1000,false,1,i);
      double bb2=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length2,2,1.0,1,1,1000,false,1,i);
