...
char barleavemavote()
  {
   if(barprice)
     {
      if(High[1]<iMA(NULL,0,period,0,method,0,1))
        {
         return SELL;
        }
      else if(Low[1]>iMA(NULL,0,period,0,method,0,1))
        {
         return BUY;
        }
     }
     ...
     {
      if(Open[1]<iMA(NULL,0,period,0,method,0,1) && Close[1]<iMA(NULL,0,period,0,method,0,1))
        {
         return SELL;
        }
      else if(Open[1]>iMA(NULL,0,period,0,method,0,1) && Close[1]>iMA(NULL,0,period,0,method,0,1))
        {
         return BUY;
        }
     }
...
char bbvote()
  {
   ...
   double bb3=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length1,2,1.0,1,1,1000,false,0,onetick+1);/*UpTrend Stop*/
   double bb4=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length2,2,1.0,1,1,1000,false,0,onetick+1);/*UpTrend Stop*/

   if(bb1>0 && bb2>=bb1 && (bb3<0 || bb4<0))
     {
      return BUY;
     }
   ...
   bb3=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length1,2,1.0,1,1,1000,false,1,onetick+1);
   bb4=iCustom(NULL,0,"::Indicators\\Downloads\\BBand Stop Alert.ex4",length2,2,1.0,1,1,1000,false,1,onetick+1);
   if(bb2>0 && bb2<=bb1 && (bb3<0 || bb4<0))
     {
      return SELL;
     }
   return NONE;
